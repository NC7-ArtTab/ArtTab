...
CREATE TABLE `art` (
                       ...
                       `art_category` CHAR(1) NOT NULL COMMENT '작품구분 => 동양화 : E, 서양화:W, 공예품:P, 기타:X',
                       ...
                       `art_status` CHAR(1) NULL DEFAULT 'R' COMMENT '작품경매현황 => Y:낙찰 건, P:경매진행중인 건, R:경매준비중인 건, F:경매종료 건 D:삭제 건',
                       PRIMARY KEY (`art_no`)
);
